...
and their archive assets, then uses published native-packages 0.5.1
...
[0.5.1 signing guide](https://github.com/crmne/native-packages/blob/v0.5.1/docs/apple-notarization.md).
